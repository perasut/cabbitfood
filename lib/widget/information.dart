...
import 'package:cabbitfood/screens/edit_info_shop.dart';
...
class _InformationState extends State<Information> {
  ...
  Future<Null> readDataUser() async {
    ...
    String url =
        '${MyConstant().domain}/UngPHP3/getUserWhereId.php?isAdd=true&id=$id';
  ...
  Widget showListInfoShop() => Column(
        children: <Widget>[
          MyStyle().showText2('รายละเอียดร้าน ${userModel.nameShop}'),
          showImage(),
          Row(
            children: <Widget>[
              MyStyle().showText2('ที่อยู่ของร้าน'),
            ],
          ),
          Row(
            children: <Widget>[
  ...
  Container showImage() {
    return Container(
      width: 200.0,
      height: 200.0,
      //  child: Image.network('http://202.43.47.251/UngPHP3/Shop/shop78639.jpg'),
